...
class CreateMeasurement:
    ...
    def generate_batch(
        ...
        temperatures = self.rng.normal(batch["means"].to_numpy(), std_dev).tolist()
        batch = batch.with_columns(pl.Series("temperature", temperatures))
    ...
    def generate_measurement_file(
        ...
        with open(file_name, mode="wb") as f:
            for i in tqdm(range(batches)):
                ...
                buffer = data.write_csv(separator=sep, float_precision=1)
